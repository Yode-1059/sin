...
function dbConect(){
    ...
    input($u_name,$t_name,$psword,$c_naem,$c_vol,$c_loca,$price,$memo);
?>
    ...
    <form action="table_in.php" method="post">
        ...
        メモ（あれば）<input type="text" name="memo">
        <?php
            echo '<input type="hidden" name="t_name" value="'.$t_name.'"><input type="text" name="pass" value="'.$psword.'"><input type="text" name="u_name" value="'.$u_name.'">'?>
        <input type="submit" name="送信" id=""></p>
    </form>
